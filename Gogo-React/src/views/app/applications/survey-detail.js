...
import SurveyQuestionBuilder from "../../../../src/containers/applications/QuestionBuilder"
...
class SurveyDetailApp extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      xx:props.match.params.surveyid,
      dept : {}

    };
    axios.get('/depts/getdept/'+this.state.xx)
    .then(res=>{
      console.log(res.data)
       this.setState({dept : res.data})
       localStorage.setItem("dept",JSON.stringify(res.data))
    })
 ...
 /*  getTeachersByDept =()=>{
  ...
  render() {
    ...
    return !this.state.dept?<div className="loading"></div>:(
      <Fragment>
          ...
          <Colxx xxs="12">
            <h1>
              ...
              <span className="align-middle d-inline-block pt-1">
               {this.state.dept.name} Department's team
              </span>
            </h1>
                    ...
                    <Row>
                      ...
                      <Colxx xxs="12" lg="8">
                        <ul className="list-unstyled mb-4">
                          ...
                          {!this.state.dept.teachers  ?<div className="loading"></div>: 
                          
                            this.state.dept.teachers.map((item, index) => {
