...
const getSkillsTeachersStat=()=> {
  axios.get('/managers/listteachers')
    .then(res => {
     ...
     setUsers([...users, {id: 4, name: value}]) 
...
export const doughnutChartData = {
  labels: ['IT', 'Telecommunications', 'Electromechanical '],
  datasets: [
    {
      label: '',
