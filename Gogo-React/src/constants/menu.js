    ...
    subs: [
      {
        ...
        label: "menu.depeatement",
        to: "/app/pages/Departements"
      },
      {
        icon: "simple-icon-credit-card",
  ...
  },
  {
    ...
    subs: [
      ...
      },
      {
        ...
        label: "menu.training-calendar",
        to: "/app/applications/TrainingCalendar"
      },
      {
        icon: "simple-icon-calendar",
        label: "menu.training-calendar",
        to: "/app/applications/SkillsMatrix"
      },
      {
