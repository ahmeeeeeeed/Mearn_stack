          ...
          <div className="user d-inline-block">
            <UncontrolledDropdown className="dropdown-menu-right">
              ...
              <span className="name mr-1">
                {JSON.parse( localStorage.getItem("connectedUser")).firstname+" "+JSON.parse( localStorage.getItem("connectedUser")).lastname}</span>
                <span>
                  <img alt="Profile" src={JSON.parse( localStorage.getItem("connectedUser")).imageUrl} />
                </span>
              </DropdownToggle> 
              <DropdownMenu className="mt-3" right>
